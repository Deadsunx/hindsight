...
**427 right / 550 settled (78%)** · Brier 0.146 · log loss 0.451 · 14 still open

Saying "50%" to all 550 of them instead would score Brier 0.250, log loss 0.693. Lower is better; every figure below is only worth what it beats.

| Call | Answered by | Settled | Right | Brier | Log loss |
| --- | --- | --- | --- | --- | --- |
| Bitcoin will be higher tomorrow than it is today. | momentum | n=60 | 28/60 (47%) | 0.254 | 0.702 |
| Geomagnetic Kp will exceed 3 within the next 24 hours. | persistence | n=60 | 44/60 (73%) | 0.189 | 0.563 |
| A magnitude 5.0+ earthquake will strike somewhere tomorrow. | base rate | n=60 | 60/60 (100%) | 0.004 | 0.059 |
| Today's most-read Wikipedia article will still be #1 tomorrow. | persistence | n=57 | 34/57 (60%) | 0.235 | 0.662 |
| The current #1 story on Hacker News will fall out of the top 10. | decay | n=60 | 54/60 (90%) | 0.090 | 0.327 |
| Tomorrow's high in New Delhi will land within 2°C of today's forecast. | trust the forecaster | n=54 | 50/54 (93%) | 0.084 | 0.326 |
| Bitcoin will be higher tomorrow than it is today. | logistic regression | n=34 | 16/34 (47%) | 0.306 | 0.849 |
| Geomagnetic Kp will exceed 3 within the next 24 hours. | logistic regression | n=35 | 26/35 (74%) | 0.186 | 0.566 |
| A magnitude 5.0+ earthquake will strike somewhere tomorrow. | logistic regression | n=35 | 35/35 (100%) | 0.003 | 0.051 |
| Today's most-read Wikipedia article will still be #1 tomorrow. | logistic regression | n=32 | 24/32 (75%) | 0.203 | 0.607 |
| The current #1 story on Hacker News will fall out of the top 10. | logistic regression | n=35 | 31/35 (89%) | 0.106 | 0.389 |
| Tomorrow's high in New Delhi will land within 2°C of today's forecast. | logistic regression | n=28 | 25/28 (89%) | 0.100 | 0.373 |
| _coin flip — the baseline_ | _50% to everything_ | n=550 | _50%_ | _0.250_ | _0.693_ |

_Sample is 550 settled bets across 61 days. Nothing here is significant yet, and it is published daily precisely so that it becomes so._
...
Judged against the coin flip's Brier of 0.250, over 550 settled bets:

- **Bitcoin will be higher tomorrow than it is today.** scores Brier **0.254** against the coin flip's 0.250 over n=60. It is worse than shrugging.
...
_Derived from the 550 settled bets in the ledger on every run, not written by hand. At this sample size none of it is significant; it is published daily so that one day it might be._
