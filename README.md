...
**427 right / 552 settled (77%)** · Brier 0.145 · log loss 0.446 · 14 still open

Saying "50%" to all 552 of them instead would score Brier 0.250, log loss 0.693. Lower is better; every figure below is only worth what it beats.

| Call | Answered by | Settled | Right | Brier | Log loss |
| --- | --- | --- | --- | --- | --- |
| Bitcoin will be higher tomorrow than it is today. | momentum | n=60 | 27/60 (45%) | 0.256 | 0.705 |
| Geomagnetic Kp will exceed 3 within the next 24 hours. | persistence | n=60 | 43/60 (72%) | 0.198 | 0.584 |
...
| The current #1 story on Hacker News will fall out of the top 10. | decay | n=60 | 55/60 (92%) | 0.078 | 0.294 |
| Tomorrow's high in New Delhi will land within 2°C of today's forecast. | trust the forecaster | n=55 | 51/55 (93%) | 0.084 | 0.324 |
| Bitcoin will be higher tomorrow than it is today. | logistic regression | n=34 | 15/34 (44%) | 0.308 | 0.852 |
| Geomagnetic Kp will exceed 3 within the next 24 hours. | logistic regression | n=35 | 25/35 (71%) | 0.202 | 0.601 |
...
| The current #1 story on Hacker News will fall out of the top 10. | logistic regression | n=35 | 32/35 (91%) | 0.080 | 0.304 |
| Tomorrow's high in New Delhi will land within 2°C of today's forecast. | logistic regression | n=29 | 26/29 (90%) | 0.097 | 0.363 |
| _coin flip — the baseline_ | _50% to everything_ | n=552 | _50%_ | _0.250_ | _0.693_ |

_Sample is 552 settled bets across 61 days. Nothing here is significant yet, and it is published daily precisely so that it becomes so._
...
- **no** — Bitcoin will be higher tomorrow than it is today. _(73% confident, logistic regression)_
- **yes** — Geomagnetic Kp will exceed 3 within the next 24 hours. _(78% confident, logistic regression)_
...
Judged against the coin flip's Brier of 0.250, over 552 settled bets:

- **Bitcoin will be higher tomorrow than it is today.** scores Brier **0.256** against the coin flip's 0.250 over n=60. It is worse than shrugging.
...
_Derived from the 552 settled bets in the ledger on every run, not written by hand. At this sample size none of it is significant; it is published daily so that one day it might be._
