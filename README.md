...
**304 right / 386 settled (79%)** · Brier 0.135 · log loss 0.419 · 14 still open

Saying "50%" to all 386 of them instead would score Brier 0.250, log loss 0.693. Lower is better; every figure below is only worth what it beats.

| Call | Answered by | Settled | Right | Brier | Log loss |
| --- | --- | --- | --- | --- | --- |
| Bitcoin will be higher tomorrow than it is today. | momentum | n=46 | 22/46 (48%) | 0.255 | 0.703 |
| Geomagnetic Kp will exceed 3 within the next 24 hours. | persistence | n=46 | 34/46 (74%) | 0.188 | 0.562 |
| A magnitude 5.0+ earthquake will strike somewhere tomorrow. | base rate | n=46 | 46/46 (100%) | 0.004 | 0.061 |
| Today's most-read Wikipedia article will still be #1 tomorrow. | persistence | n=43 | 25/43 (58%) | 0.239 | 0.670 |
| The current #1 story on Hacker News will fall out of the top 10. | decay | n=46 | 43/46 (93%) | 0.064 | 0.258 |
| Tomorrow's high in New Delhi will land within 2°C of today's forecast. | trust the forecaster | n=42 | 41/42 (98%) | 0.054 | 0.256 |
| Bitcoin will be higher tomorrow than it is today. | logistic regression | n=20 | 9/20 (45%) | 0.308 | 0.870 |
| Geomagnetic Kp will exceed 3 within the next 24 hours. | logistic regression | n=21 | 14/21 (67%) | 0.214 | 0.623 |
| A magnitude 5.0+ earthquake will strike somewhere tomorrow. | logistic regression | n=21 | 21/21 (100%) | 0.003 | 0.051 |
| Today's most-read Wikipedia article will still be #1 tomorrow. | logistic regression | n=18 | 13/18 (72%) | 0.236 | 0.694 |
| The current #1 story on Hacker News will fall out of the top 10. | logistic regression | n=21 | 20/21 (95%) | 0.047 | 0.206 |
| Tomorrow's high in New Delhi will land within 2°C of today's forecast. | logistic regression | n=16 | 16/16 (100%) | 0.003 | 0.057 |
| _coin flip — the baseline_ | _50% to everything_ | n=386 | _50%_ | _0.250_ | _0.693_ |

_Sample is 386 settled bets across 47 days. Nothing here is significant yet, and it is published daily precisely so that it becomes so._
...
- **no** — Geomagnetic Kp will exceed 3 within the next 24 hours. _(76% confident, logistic regression)_
...
Judged against the coin flip's Brier of 0.250, over 386 settled bets:

- **Bitcoin will be higher tomorrow than it is today.** scores Brier **0.255** against the coin flip's 0.250 over n=46. It is worse than shrugging.
...
_Derived from the 386 settled bets in the ledger on every run, not written by hand. At this sample size none of it is significant; it is published daily so that one day it might be._
