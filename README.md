...
**410 right / 526 settled (78%)** · Brier 0.142 · log loss 0.439 · 14 still open

Saying "50%" to all 526 of them instead would score Brier 0.250, log loss 0.693. Lower is better; every figure below is only worth what it beats.
...
| Today's most-read Wikipedia article will still be #1 tomorrow. | persistence | n=54 | 32/54 (59%) | 0.235 | 0.663 |
...
| Today's most-read Wikipedia article will still be #1 tomorrow. | logistic regression | n=29 | 22/29 (76%) | 0.208 | 0.619 |
...
| _coin flip — the baseline_ | _50% to everything_ | n=526 | _50%_ | _0.250_ | _0.693_ |

_Sample is 526 settled bets across 59 days. Nothing here is significant yet, and it is published daily precisely so that it becomes so._
...
- **no** — Bitcoin will be higher tomorrow than it is today. _(63% confident, logistic regression)_
...
Judged against the coin flip's Brier of 0.250, over 526 settled bets:
...
_Derived from the 526 settled bets in the ledger on every run, not written by hand. At this sample size none of it is significant; it is published daily so that one day it might be._
