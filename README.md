...
**74 right / 95 settled (78%)** · Brier 0.143 · log loss 0.444 · 7 still open

Saying "50%" to all 95 of them instead would score Brier 0.250, log loss 0.693. Lower is better; every figure below is only worth what it beats.

| Call | Answered by | Settled | Right | Brier | Log loss |
| --- | --- | --- | --- | --- | --- |
| Bitcoin will be higher tomorrow than it is today. | momentum | n=16 | 8/16 (50%) | 0.253 | 0.700 |
| Geomagnetic Kp will exceed 3 within the next 24 hours. | persistence | n=16 | 12/16 (75%) | 0.181 | 0.546 |
| A magnitude 5.0+ earthquake will strike somewhere tomorrow. | base rate | n=16 | 16/16 (100%) | 0.007 | 0.079 |
| Today's most-read Wikipedia article will still be #1 tomorrow. | persistence | n=16 | 10/16 (62%) | 0.224 | 0.638 |
| The current #1 story on Hacker News will fall out of the top 10. | decay | n=16 | 14/16 (88%) | 0.109 | 0.377 |
| Tomorrow's high in New Delhi will land within 2°C of today's forecast. | trust the forecaster | n=15 | 14/15 (93%) | 0.080 | 0.316 |
| _coin flip — the baseline_ | _50% to everything_ | n=95 | _50%_ | _0.250_ | _0.693_ |

_Sample is 95 settled bets across 17 days. Nothing here is significant yet, and it is published daily precisely so that it becomes so._
...
Judged against the coin flip's Brier of 0.250, over 95 settled bets:

- **Bitcoin will be higher tomorrow than it is today.** scores Brier **0.253** against the coin flip's 0.250 over n=16. It is worse than shrugging.
...
_Derived from the 95 settled bets in the ledger on every run, not written by hand. At this sample size none of it is significant; it is published daily so that one day it might be._
