...
**69 right / 89 settled (78%)** · Brier 0.144 · log loss 0.446 · 7 still open

Saying "50%" to all 89 of them instead would score Brier 0.250, log loss 0.693. Lower is better; every figure below is only worth what it beats.

| Call | Answered by | Settled | Right | Brier | Log loss |
| --- | --- | --- | --- | --- | --- |
| Bitcoin will be higher tomorrow than it is today. | momentum | n=15 | 7/15 (47%) | 0.256 | 0.705 |
| Geomagnetic Kp will exceed 3 within the next 24 hours. | persistence | n=15 | 11/15 (73%) | 0.190 | 0.566 |
| A magnitude 5.0+ earthquake will strike somewhere tomorrow. | base rate | n=15 | 15/15 (100%) | 0.008 | 0.081 |
| Today's most-read Wikipedia article will still be #1 tomorrow. | persistence | n=15 | 10/15 (67%) | 0.206 | 0.600 |
| The current #1 story on Hacker News will fall out of the top 10. | decay | n=15 | 13/15 (87%) | 0.116 | 0.394 |
| Tomorrow's high in New Delhi will land within 2°C of today's forecast. | trust the forecaster | n=14 | 13/14 (93%) | 0.083 | 0.322 |
| _coin flip — the baseline_ | _50% to everything_ | n=89 | _50%_ | _0.250_ | _0.693_ |

_Sample is 89 settled bets across 16 days. Nothing here is significant yet, and it is published daily precisely so that it becomes so._
...
Judged against the coin flip's Brier of 0.250, over 89 settled bets:

- **Bitcoin will be higher tomorrow than it is today.** scores Brier **0.256** against the coin flip's 0.250 over n=15. It is worse than shrugging.
...
- **The current #1 story on Hacker News will fall out of the top 10.** is effectively one-sided: the event happened 87% of the time, so always calling the majority side would have scored 87% against this rule's 87%. Accuracy here measures the question, not the predictor.
...
_Derived from the 89 settled bets in the ledger on every run, not written by hand. At this sample size none of it is significant; it is published daily so that one day it might be._
