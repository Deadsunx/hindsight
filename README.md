...
**412 right / 528 settled (78%)** · Brier 0.141 · log loss 0.439 · 14 still open

Saying "50%" to all 528 of them instead would score Brier 0.250, log loss 0.693. Lower is better; every figure below is only worth what it beats.

| Call | Answered by | Settled | Right | Brier | Log loss |
| --- | --- | --- | --- | --- | --- |
| Bitcoin will be higher tomorrow than it is today. | momentum | n=58 | 27/58 (47%) | 0.255 | 0.703 |
| Geomagnetic Kp will exceed 3 within the next 24 hours. | persistence | n=58 | 42/58 (72%) | 0.194 | 0.574 |
| A magnitude 5.0+ earthquake will strike somewhere tomorrow. | base rate | n=58 | 58/58 (100%) | 0.004 | 0.059 |
| Today's most-read Wikipedia article will still be #1 tomorrow. | persistence | n=55 | 33/55 (60%) | 0.233 | 0.657 |
| The current #1 story on Hacker News will fall out of the top 10. | decay | n=58 | 54/58 (93%) | 0.067 | 0.265 |
| Tomorrow's high in New Delhi will land within 2°C of today's forecast. | trust the forecaster | n=53 | 49/53 (92%) | 0.085 | 0.328 |
| Bitcoin will be higher tomorrow than it is today. | logistic regression | n=32 | 14/32 (44%) | 0.311 | 0.861 |
| Geomagnetic Kp will exceed 3 within the next 24 hours. | logistic regression | n=33 | 24/33 (73%) | 0.194 | 0.585 |
| A magnitude 5.0+ earthquake will strike somewhere tomorrow. | logistic regression | n=33 | 33/33 (100%) | 0.003 | 0.051 |
| Today's most-read Wikipedia article will still be #1 tomorrow. | logistic regression | n=30 | 23/30 (77%) | 0.203 | 0.607 |
| The current #1 story on Hacker News will fall out of the top 10. | logistic regression | n=33 | 31/33 (94%) | 0.059 | 0.245 |
| Tomorrow's high in New Delhi will land within 2°C of today's forecast. | logistic regression | n=27 | 24/27 (89%) | 0.103 | 0.384 |
| _coin flip — the baseline_ | _50% to everything_ | n=528 | _50%_ | _0.250_ | _0.693_ |

_Sample is 528 settled bets across 59 days. Nothing here is significant yet, and it is published daily precisely so that it becomes so._
...
- **no** — Bitcoin will be higher tomorrow than it is today. _(50% confident, logistic regression)_
...
- **yes** — Today's most-read Wikipedia article will still be #1 tomorrow. _(67% confident, logistic regression)_
...
Judged against the coin flip's Brier of 0.250, over 528 settled bets:

- **Bitcoin will be higher tomorrow than it is today.** scores Brier **0.255** against the coin flip's 0.250 over n=58. It is worse than shrugging.
...
_Derived from the 528 settled bets in the ledger on every run, not written by hand. At this sample size none of it is significant; it is published daily so that one day it might be._
