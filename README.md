...
**162 right / 200 settled (81%)** · Brier 0.129 · log loss 0.409 · 14 still open
...
| --- | --- | --- | --- | --- | --- |
| Bitcoin will be higher tomorrow than it is today. | momentum | n=30 | 16/30 (53%) | 0.250 | 0.694 |
...
| The current #1 story on Hacker News will fall out of the top 10. | decay | n=30 | 28/30 (93%) | 0.065 | 0.261 |
| Tomorrow's high in New Delhi will land within 2°C of today's forecast. | trust the forecaster | n=29 | 28/29 (97%) | 0.061 | 0.271 |
| Bitcoin will be higher tomorrow than it is today. | logistic regression | n=4 | 2/4 (50%) | 0.385 | 1.209 |
...
| The current #1 story on Hacker News will fall out of the top 10. | logistic regression | n=5 | 5/5 (100%) | 0.006 | 0.081 |
...
- **Bitcoin will be higher tomorrow than it is today.** scores Brier **0.250** against the coin flip's 0.250 over n=30. It is worse than shrugging.
