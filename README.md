...
**335 right / 424 settled (79%)** · Brier 0.132 · log loss 0.411 · 14 still open

Saying "50%" to all 424 of them instead would score Brier 0.250, log loss 0.693. Lower is better; every figure below is only worth what it beats.

| Call | Answered by | Settled | Right | Brier | Log loss |
| --- | --- | --- | --- | --- | --- |
| Bitcoin will be higher tomorrow than it is today. | momentum | n=49 | 23/49 (47%) | 0.255 | 0.703 |
| Geomagnetic Kp will exceed 3 within the next 24 hours. | persistence | n=49 | 37/49 (76%) | 0.179 | 0.542 |
| A magnitude 5.0+ earthquake will strike somewhere tomorrow. | base rate | n=49 | 49/49 (100%) | 0.004 | 0.060 |
| Today's most-read Wikipedia article will still be #1 tomorrow. | persistence | n=46 | 27/46 (59%) | 0.239 | 0.671 |
| The current #1 story on Hacker News will fall out of the top 10. | decay | n=49 | 46/49 (94%) | 0.061 | 0.250 |
| Tomorrow's high in New Delhi will land within 2°C of today's forecast. | trust the forecaster | n=46 | 45/46 (98%) | 0.053 | 0.253 |
| Bitcoin will be higher tomorrow than it is today. | logistic regression | n=23 | 10/23 (43%) | 0.303 | 0.850 |
| Geomagnetic Kp will exceed 3 within the next 24 hours. | logistic regression | n=24 | 17/24 (71%) | 0.193 | 0.575 |
| A magnitude 5.0+ earthquake will strike somewhere tomorrow. | logistic regression | n=24 | 24/24 (100%) | 0.003 | 0.051 |
| Today's most-read Wikipedia article will still be #1 tomorrow. | logistic regression | n=21 | 14/21 (67%) | 0.250 | 0.720 |
| The current #1 story on Hacker News will fall out of the top 10. | logistic regression | n=24 | 23/24 (96%) | 0.042 | 0.190 |
| Tomorrow's high in New Delhi will land within 2°C of today's forecast. | logistic regression | n=20 | 20/20 (100%) | 0.003 | 0.055 |
| _coin flip — the baseline_ | _50% to everything_ | n=424 | _50%_ | _0.250_ | _0.693_ |

_Sample is 424 settled bets across 50 days. Nothing here is significant yet, and it is published daily precisely so that it becomes so._
...
- **yes** — Bitcoin will be higher tomorrow than it is today. _(74% confident, logistic regression)_
- **no** — Geomagnetic Kp will exceed 3 within the next 24 hours. _(88% confident, logistic regression)_
...
Judged against the coin flip's Brier of 0.250, over 424 settled bets:

- **Bitcoin will be higher tomorrow than it is today.** scores Brier **0.255** against the coin flip's 0.250 over n=49. It is worse than shrugging.
...
_Derived from the 424 settled bets in the ledger on every run, not written by hand. At this sample size none of it is significant; it is published daily so that one day it might be._
