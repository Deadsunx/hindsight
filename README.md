...
**116 right / 146 settled (79%)** · Brier 0.134 · log loss 0.421 · 10 still open

Saying "50%" to all 146 of them instead would score Brier 0.250, log loss 0.693. Lower is better; every figure below is only worth what it beats.

| Call | Answered by | Settled | Right | Brier | Log loss |
| --- | --- | --- | --- | --- | --- |
| Bitcoin will be higher tomorrow than it is today. | momentum | n=25 | 13/25 (52%) | 0.249 | 0.691 |
| Geomagnetic Kp will exceed 3 within the next 24 hours. | persistence | n=25 | 18/25 (72%) | 0.199 | 0.587 |
| A magnitude 5.0+ earthquake will strike somewhere tomorrow. | base rate | n=25 | 25/25 (100%) | 0.006 | 0.069 |
| Today's most-read Wikipedia article will still be #1 tomorrow. | persistence | n=22 | 14/22 (64%) | 0.219 | 0.628 |
| The current #1 story on Hacker News will fall out of the top 10. | decay | n=25 | 23/25 (92%) | 0.075 | 0.287 |
| Tomorrow's high in New Delhi will land within 2°C of today's forecast. | trust the forecaster | n=24 | 23/24 (96%) | 0.065 | 0.281 |
| _coin flip — the baseline_ | _50% to everything_ | n=146 | _50%_ | _0.250_ | _0.693_ |

_Sample is 146 settled bets across 26 days. Nothing here is significant yet, and it is published daily precisely so that it becomes so._
...
- **no** — Geomagnetic Kp will exceed 3 within the next 24 hours. _(74% confident, logistic regression)_
...
Judged against the coin flip's Brier of 0.250, over 146 settled bets:
...
_Derived from the 146 settled bets in the ledger on every run, not written by hand. At this sample size none of it is significant; it is published daily so that one day it might be._
