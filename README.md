...
**421 right / 540 settled (78%)** · Brier 0.143 · log loss 0.443 · 14 still open

Saying "50%" to all 540 of them instead would score Brier 0.250, log loss 0.693. Lower is better; every figure below is only worth what it beats.

| Call | Answered by | Settled | Right | Brier | Log loss |
| --- | --- | --- | --- | --- | --- |
| Bitcoin will be higher tomorrow than it is today. | momentum | n=59 | 27/59 (46%) | 0.255 | 0.703 |
| Geomagnetic Kp will exceed 3 within the next 24 hours. | persistence | n=59 | 43/59 (73%) | 0.191 | 0.568 |
| A magnitude 5.0+ earthquake will strike somewhere tomorrow. | base rate | n=59 | 59/59 (100%) | 0.004 | 0.059 |
| Today's most-read Wikipedia article will still be #1 tomorrow. | persistence | n=56 | 34/56 (61%) | 0.230 | 0.652 |
| The current #1 story on Hacker News will fall out of the top 10. | decay | n=59 | 54/59 (92%) | 0.079 | 0.297 |
| Tomorrow's high in New Delhi will land within 2°C of today's forecast. | trust the forecaster | n=54 | 50/54 (93%) | 0.084 | 0.326 |
| Bitcoin will be higher tomorrow than it is today. | logistic regression | n=33 | 15/33 (45%) | 0.309 | 0.855 |
| Geomagnetic Kp will exceed 3 within the next 24 hours. | logistic regression | n=34 | 25/34 (74%) | 0.190 | 0.575 |
| A magnitude 5.0+ earthquake will strike somewhere tomorrow. | logistic regression | n=34 | 34/34 (100%) | 0.003 | 0.051 |
| Today's most-read Wikipedia article will still be #1 tomorrow. | logistic regression | n=31 | 24/31 (77%) | 0.200 | 0.601 |
| The current #1 story on Hacker News will fall out of the top 10. | logistic regression | n=34 | 31/34 (91%) | 0.082 | 0.312 |
| Tomorrow's high in New Delhi will land within 2°C of today's forecast. | logistic regression | n=28 | 25/28 (89%) | 0.100 | 0.373 |
| _coin flip — the baseline_ | _50% to everything_ | n=540 | _50%_ | _0.250_ | _0.693_ |

_Sample is 540 settled bets across 60 days. Nothing here is significant yet, and it is published daily precisely so that it becomes so._
...
- **no** — Geomagnetic Kp will exceed 3 within the next 24 hours. _(77% confident, logistic regression)_
- **yes** — A magnitude 5.0+ earthquake will strike somewhere tomorrow. _(95% confident, logistic regression)_
- **yes** — Today's most-read Wikipedia article will still be #1 tomorrow. _(55% confident, logistic regression)_
- **yes** — The current #1 story on Hacker News will fall out of the top 10. _(95% confident, logistic regression)_
- **yes** — Tomorrow's high in New Delhi will land within 2°C of today's forecast. _(93% confident, logistic regression)_
...
Judged against the coin flip's Brier of 0.250, over 540 settled bets:

- **Bitcoin will be higher tomorrow than it is today.** scores Brier **0.255** against the coin flip's 0.250 over n=59. It is worse than shrugging.
...
_Derived from the 540 settled bets in the ledger on every run, not written by hand. At this sample size none of it is significant; it is published daily so that one day it might be._
