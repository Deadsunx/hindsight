...
| The current #1 story on Hacker News will fall out of the top 10. | decay | n=12 | 10/12 (83%) | 0.141 | 0.460 |
| Tomorrow's high in New Delhi will land within 2°C of today's forecast. | trust the forecaster | n=11 | 10/11 (91%) | 0.095 | 0.349 |
| _coin flip — the baseline_ | _50% to everything_ | n=71 | _50%_ | _0.250_ | _0.693_ |

_Sample is 71 settled bets across 13 days. Nothing here is significant yet, and it is published daily precisely so that it becomes so._
...
_Derived from the 71 settled bets in the ledger on every run, not written by hand. At this sample size none of it is significant; it is published daily so that one day it might be._
